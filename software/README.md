...
You will need:
- Mira driver
- Libcamera framework with mira support added.
...
- Linux driver for [mira220](github.com/ams-OSRAM/mira220_v4l2_driver) guide. 
- Linux driver [mira016](https://github.com/ams-OSRAM/mira016_v4l2_driver) guide. 
